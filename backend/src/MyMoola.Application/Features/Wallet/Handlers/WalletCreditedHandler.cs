...
public sealed class WalletCreditedHandler(
    ILedgerEntryRepository ledgerEntries) : INotificationHandler<WalletCreditedEvent>
{
    public Task Handle(WalletCreditedEvent evt, CancellationToken ct)
    {
