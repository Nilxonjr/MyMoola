...
namespace MyMoola.Infrastructure.Migrations
{
    ...
    [Migration("20260509125529_UpdateIdempotencyIndexAndDropIdempotencyTable")]
    partial class UpdateIdempotencyIndexAndDropIdempotencyTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyMoola.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasIndex("InitiatorUserId", "IdempotencyKey")
                        ...
                        .HasFilter("[initiator_user_id] IS NOT NULL");
