        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rate_kes = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    rate_usd = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    buy_rate_kes = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    sell_rate_kes = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    spread_percent = table.Column<decimal>(type: "numeric(6,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    control_key = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    amount = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    fee_amount = table.Column<decimal>(type: "numeric(28,18)", nullable: false, defaultValue: 0m),
                    kes_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    exchange_rate_snapshot = table.Column<decimal>(type: "numeric(28,8)", nullable: true),
                    market_rate_snapshot = table.Column<decimal>(type: "numeric(28,8)", nullable: true),
                    mpesa_reference = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    on_chain_tx_hash = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    on_chain_confirmations = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    balance = table.Column<decimal>(type: "numeric(28,18)", nullable: false, defaultValue: 0m),
                    kes_reserve = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    coverage_ratio = table.Column<decimal>(type: "numeric(8,4)", nullable: false, defaultValue: 0m),
                    buy_halted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    last_rebalanced_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    freeze_reason = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    checkout_request_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    amount_kes = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    derivation_path = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    balance = table.Column<decimal>(type: "numeric(28,18)", nullable: false, defaultValue: 0m),
                    locked_balance = table.Column<decimal>(type: "numeric(28,18)", nullable: false, defaultValue: 0m),
                    Version = table.Column<long>(type: "bigint", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    amount = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    available_balance_before = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    available_balance_after = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    locked_balance_before = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    locked_balance_after = table.Column<decimal>(type: "numeric(28,18)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
